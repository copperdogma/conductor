...
- Already covered by an existing skill, doc, or memory?
...
Which exact file, skill, memory path, story, alignment note, or target-project
workflow would be changed after acceptance?
